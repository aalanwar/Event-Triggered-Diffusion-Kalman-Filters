...
reporterr_ped01= reporterr_aggregated(:,1:3);
reportmsg_ped01= reportmsg_aggregated(:,1:3);
% prepare percentage!
...
numofrows= 2;
uu= length(reporterr_ped01);
reporterr_ped01=[ reporterr_ped01 ; reporterr_aggregated(1:numofrows,1:3)];
reportmsg_ped01= reportmsg_aggregated(:,1:3);
% prepare percentage!
reportmsg_perc_ped01_less1 = reportmsg_ped01(:,1:3);
%Multiply *2 as diff=meas mesg
reportmsg_perc_ped01_less1(:,2) = reportmsg_perc_ped01_less1(:,2)*2;
reportmsg_perc_ped01_less1(:,3) = reportmsg_perc_ped01_less1(:,3)*2;
%totalNumMsg1 = reportmsg_perc_ped01(1,3);
ss= length(reportmsg_perc_ped01);
reportmsg_perc_ped01(ss+1:ss+numofrows+1,1) = reportmsg_perc_ped01_less1(:,1);
reportmsg_perc_ped01(ss+1:ss+numofrows+1,2) = reportmsg_perc_ped01_less1(:,2)/totalNumMsg1;
reportmsg_perc_ped01(ss+1:ss+numofrows+1,3) = reportmsg_perc_ped01_less1(:,3)/totalNumMsg1;
...
load(strcat(filepath,num2str(ID),'_less1' ));
reporterr_ped02(end+1:end+numofrows,:)= reporterr_aggregated(1:numofrows,1:3);
reportmsg_ped02= reportmsg_aggregated;
% prepare percentage!
reportmsg_perc_ped02_less2 = reportmsg_ped02(:,1:3);
%Multiply *2 as diff=meas mesg
reportmsg_perc_ped02_less2(:,2) = reportmsg_perc_ped02_less2(:,2)*2;
reportmsg_perc_ped02_less2(:,3) = reportmsg_perc_ped02_less2(:,3)*2;
%totalNumMsg1 = reportmsg_perc_ped01(1,3);
reportmsg_perc_ped02(ss+1:ss+numofrows+1,1) = reportmsg_perc_ped02_less2(:,1);
reportmsg_perc_ped02(ss+1:ss+numofrows+1,2) = reportmsg_perc_ped02_less2(:,2)/totalNumMsg2;
reportmsg_perc_ped02(ss+1:ss+numofrows+1,3) = reportmsg_perc_ped02_less2(:,3)/totalNumMsg2;
%%%%%%%%%%%%%%%%%%%%%%%%%%%
ID = 3;
load(strcat(filepath,num2str(ID)));
...
load(strcat(filepath,num2str(ID),'_less1' ));
reporterr_ped03(end+1:end+numofrows,:)= reporterr_aggregated(1:numofrows,:);
reportmsg_ped03= reportmsg_aggregated;
% prepare percentage!
reportmsg_perc_ped03_less3 = reportmsg_ped03(:,1:3);
%Multiply *2 as diff=meas mesg
reportmsg_perc_ped03_less3(:,2) = reportmsg_perc_ped03_less3(:,2)*2;
reportmsg_perc_ped03_less3(:,3) = reportmsg_perc_ped03_less3(:,3)*2;
%totalNumMsg1 = reportmsg_perc_ped01(1,3);
reportmsg_perc_ped03(ss+1:ss+numofrows+1,1) = reportmsg_perc_ped03_less3(:,1);
reportmsg_perc_ped03(ss+1:ss+numofrows+1,2) = reportmsg_perc_ped03_less3(:,2)/totalNumMsg3;
reportmsg_perc_ped03(ss+1:ss+numofrows+1,3) = reportmsg_perc_ped03_less3(:,3)/totalNumMsg3;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
ID = 4;
load(strcat(filepath,num2str(ID)));
...
load(strcat(filepath,num2str(ID),'_less1' ));
reporterr_ped04(end+1:end+numofrows,:)= reporterr_aggregated(1:numofrows,1:3);
reportmsg_ped04= reportmsg_aggregated;
% prepare percentage!
reportmsg_perc_ped04_less4 = reportmsg_ped04(:,1:3);
%Multiply *2 as diff=meas mesg
reportmsg_perc_ped04_less4(:,2) = reportmsg_perc_ped04_less4(:,2)*2;
reportmsg_perc_ped04_less4(:,3) = reportmsg_perc_ped04_less4(:,3)*2;
%totalNumMsg1 = reportmsg_perc_ped01(1,3);
reportmsg_perc_ped04(ss+1:ss+numofrows+1,1) = reportmsg_perc_ped04_less4(:,1);
reportmsg_perc_ped04(ss+1:ss+numofrows+1,2) = reportmsg_perc_ped04_less4(:,2)/totalNumMsg4;
reportmsg_perc_ped04(ss+1:ss+numofrows+1,3) = reportmsg_perc_ped03_less3(:,3)/totalNumMsg4;
...
reporterr_ped01 = [reporterr_ped01_orig(1,:) ; reporterr_ped01_orig(12:14,:) ; reporterr_ped01_orig(2:11,:) ];
reporterr = [reporterr_orig(1,:) ; reporterr_orig(12:14,:) ; reporterr_orig(2:11,:) ];
reportmsg = [reportmsg_orig(1,:) ; reportmsg_orig(12:14,:) ; reportmsg_orig(2:11,:) ];
figure
x = reporterr_ped01(:,1);
y = reporterr(:,2); 
err = reporterr(:,3);
...
[reportmsg(:,1),new_amount_all,PERCENT_INCREASE_all,reportmsg(:,2)*100]'
